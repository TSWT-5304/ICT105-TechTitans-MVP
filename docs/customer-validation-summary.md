...
|---|---|---|
| TU-01 | Student | Primary user who searches for tutors and submits tutoring requests. |
| TU-02 | Student | Evaluates tutor search, tutor profiles, and payment workflow. |
| TU-03 | Student | Tests request submission and dashboard usability. |
| TU-04 | Student | Validates payment process and request tracking. |
| TU-05 | Student | Evaluates overall user experience and reviews. |
| TU-06 | Student Tutor | Tests tutor registration and tutor profile management. |
| TU-07 | Student Tutor | Evaluates tutor dashboard and request management. |
| TU-08 | Student Tutor | Tests payment status, tutor earnings, and reviews. |
| TU-09 | Administrator | Validates tutor approval, payment verification, and user management. |
| TU-10 | Administrator | Tests dashboard analytics and platform administration. |

## 4. Validation Method
The MVP prototype was evaluated through task-based usability testing. Each participant completed tasks according to their assigned role (Student, Student Tutor, or Administrator) while the team observed task completion, navigation, and user interactions. After completing the tasks, participants completed a feedback questionnaire and provided suggestions for improvement.
- **Testing Method:** Task-based usability testing with a clickable web prototype
- **Date/Time:** July 16, 2026
- **Location or Online Platform:** Computer Laboratory / Online Demonstration (Google Meet)
